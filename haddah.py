...
CITIES_DISTRICTS = {
    "مكة المكرمة": [
        ...
        # أحياء ومناطق ذكرتها في طلباتك السابقة
        "الغزال", "الحكير", "النسيم", "جعرانة", "شرائع المجاهدين",
        
        # معالم هامة (يطلبها العملاء غالباً)
        "الحرم", "برج الساعة", "محطة القطار", "جامعة ام القرى", "سوق الضيافة",
        "مكة مول", "الحجاز مول"
    ],
    ...
    "جدة": [
        ...
        "البوادي", "الصفا", "المروة", "الفيصلية",
        
        # وسط جدة
        "التحليه", "الاندلس", "الحمراء", "الرويس", "الشرفية", "مشرفة", "العزيزية",
        "الرحاب", "النسيم", "بني مالك", "الورود", "الفحياء", "الثغر",
        
        # شرق جدة
        "السامر", "المنار", "الاجواد", "الواحة", "الحمدانية", "الصالحية", "الرحمانية",
        "الريان", "الكوثر", "الفلاح", "طيبة", "السليمانية",
        
        # جنوب جدة والوسط القديم
        "البلد", "البغدادية", "السبيل", "الهنداوية", "الكندرة", "العمارية", "الصحيفة",
        "القرى", "السبيل", "النزلة", "مدائن الفهد", "الوزيرية", "الجوهرة", "السنابل",
        "الاجاويد", "الامير فواز", "الخمرة", "القرينية", "ابو جعالة",
        
        # معالم هامة
        "المطار", "محطة القطار", "الواجهة البحرية", "الرد سي مول", "العرب مول",
        "الياسمين مول", "عزيز مول", "الجامعة", "جامعة الملك عبدالعزيز"
    ]
}
